    ...
    <div className="min-h-screen bg-[#EFEFEF] font-sans text-black overflow-x-hidden">
      ...
      <nav className="flex justify-between items-center p-6 bg-white border-b-8 border-black sticky top-0 z-50">
        <div className="flex items-center gap-8">
          {/* LOGO ANIMADA - CAMINHO RELATIVO SEM BARRA INICIAL */}
        ...
        <button className="hidden lg:block bg-[#D63230] text-white px-12 py-5 font-black italic border-4 border-black shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] hover:translate-x-[4px] hover:translate-y-[4px] hover:shadow-none transition-all uppercase text-xl text-white">
          Quero meu Café
        </button>
      </nav>
      ...
      <header className="container mx-auto px-6 py-20 flex flex-col lg:flex-row items-center gap-10">
        <div className="lg:w-1/2 text-left z-10">
          <div className="inline-block bg-black text-white px-8 py-2 mb-10 italic font-black skew-x-[-12deg] text-2xl uppercase text-white">
          ...
          <a href="#planos" className="inline-block bg-black text-white px-16 py-8 font-black italic text-3xl uppercase border-4 border-black shadow-[12px_12px_0px_0px_rgba(214,50,48,1)] hover:bg-[#D63230] hover:scale-105 transition-all text-white">
            Ver Assinaturas
          </a>
        </div>

        {/* ÁREA DO MASCOTE GIGANTE */}
        <div className="lg:w-1/2 flex justify-center relative mt-10 lg:mt-0">
           ...
           <div className="absolute -top-20 -right-10 bg-[#D63230] text-white w-40 h-40 rounded-full border-8 border-black flex items-center justify-center font-black italic text-center animate-bounce z-20 text-lg rotate-12 shadow-2xl leading-none text-white">
      ...
      <section className="bg-black text-white py-16">
        <div className="container mx-auto px-6 grid md:grid-cols-4 gap-8 text-center uppercase font-black italic">
          <div className="border-2 border-[#D63230] p-4 text-white">Variedade: Mundo Novo</div>
          <div className="border-2 border-[#D63230] p-4 text-white">Torra: Média</div>
          <div className="border-2 border-[#D63230] p-4 text-white">Intensidade: Equilibrada</div>
          <div className="border-2 border-[#D63230] p-4 text-white">Corpo: Médio</div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-6 text-center md:text-left">
          ...
          <div className="grid lg:grid-cols-3 gap-16">
            ...
            <div className="border-[8px] border-black p-12 flex flex-col bg-[#D63230] text-white shadow-[20px_20px_0px_0px_rgba(0,0,0,1)] scale-110 z-10 relative">
              <div className="absolute -top-8 left-1/2 -translate-x-1/2 bg-black text-white text-sm font-black uppercase px-8 py-3 border-4 border-white italic text-center text-white">Favorito da Comunidade</div>
              ...
              <p className="text-2xl font-bold flex-grow mb-10 leading-tight italic text-white">
                "Equilíbrio constante para quem mantém uma rotina de alta performance."
              </p>
              <div className="text-5xl font-black mb-10 border-b-4 border-white pb-4 tracking-tighter text-white">R$ 68,00</div>
              <button className="w-full bg-black text-white py-6 font-black uppercase text-2xl hover:bg-white hover:text-black transition-all border-4 border-black text-white">Assinar Agora</button>
            </div>
      ...
      <footer className="bg-black text-white py-24 px-10 border-t-[15px] border-[#D63230]">
        <div className="container mx-auto flex flex-col lg:flex-row justify-between items-center gap-16">
          <div className="text-center lg:text-left">
            <div className="text-7xl font-black italic uppercase leading-none mb-4 text-white">
              Speed <span className="text-[#D63230]">Café</span>
            </div>
            <p className="text-xl font-bold uppercase tracking-[0.5em] opacity-80 text-white">
              By Castelhana Farm | 2026
            </p>
          </div>
          <div className="max-w-md text-center lg:text-right text-white">
            <p className="italic font-black text-3xl mb-8 leading-none uppercase text-white">
              "Deguste. Sinta. Acelere."
            </p>
            <p className="text-sm opacity-50 uppercase font-bold text-white">
